...
async def main():
    ...
    BOT_TOKEN = "7779270006:AAHL1jkC3jyEMI7TaBy21ypLMmicGYhLYs0"  # <-- Add your Telegram bot token here
    ...
    try:
        ...
        application.run_polling()  # No need for idle() anymore in newer versions
